...
private:
    typedef unordered_map<string, Object> Ob_Map;
    typedef vector<Ob_Map> M_Vec;
    M_Vec vars;
    Ob_Map &Glo_Vars();
    Ob_Map &Cur_Vars();
    Object FindVar (const Object &name);
    std::unordered_map<std::string, Object>::iterator GetVar (const Object &name);
    Object &Insert_Var (const Object &name, const Object &value);
    Object &Assign_Var (const Object &name, const Object &value);

public:
    class Function {
    public:
        typedef vector<pair<string, Object> > Para;
        Para paras;
        Python3Parser::SuiteContext *suis;
        Function() = default;
        Function ( Para para,  Python3Parser::SuiteContext * sui): paras (para), suis(sui) {};
    };
